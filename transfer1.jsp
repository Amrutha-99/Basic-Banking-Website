 ...
 table{
   ...
   %> 
    ...
    <%}
       ...
       try{
       Class.forName("oracle.jdbc.driver.OracleDriver");
   Connection con1=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","amrutha99","54321");
   Statement st1=con1.createStatement();
   ResultSet rs1=st1.executeQuery("select * from customers where account_number='"+s11+"'");
